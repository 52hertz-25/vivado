...
entity lenet_full_top_control_s_axi is
generic (
...
end entity lenet_full_top_control_s_axi;
...
architecture behave of lenet_full_top_control_s_axi is
    ...
    constant ADDR_FEATURE_IN_DATA_0  : INTEGER := 16#10#;
    constant ADDR_FEATURE_IN_DATA_1  : INTEGER := 16#14#;
    constant ADDR_FEATURE_IN_CTRL    : INTEGER := 16#18#;
    ...
    constant ADDR_FEATURE_OUT_DATA_0 : INTEGER := 16#34#;
    constant ADDR_FEATURE_OUT_DATA_1 : INTEGER := 16#38#;
    constant ADDR_FEATURE_OUT_CTRL   : INTEGER := 16#3c#;
