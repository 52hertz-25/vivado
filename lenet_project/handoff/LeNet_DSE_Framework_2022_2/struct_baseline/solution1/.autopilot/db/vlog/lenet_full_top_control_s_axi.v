...
// ==============================================================
`timescale 1ns/1ps
module lenet_full_top_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                = 6'h08,
    ADDR_ISR                = 6'h0c,
    ADDR_FEATURE_IN_DATA_0  = 6'h10,
    ADDR_FEATURE_IN_DATA_1  = 6'h14,
    ADDR_FEATURE_IN_CTRL    = 6'h18,
    ...
    ADDR_FEATURE_OUT_DATA_0 = 6'h34,
    ADDR_FEATURE_OUT_DATA_1 = 6'h38,
    ADDR_FEATURE_OUT_CTRL   = 6'h3c,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
