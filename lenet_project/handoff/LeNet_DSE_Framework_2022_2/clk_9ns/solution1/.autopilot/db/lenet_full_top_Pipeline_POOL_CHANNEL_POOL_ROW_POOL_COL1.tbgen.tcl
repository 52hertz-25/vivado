set moduleName lenet_full_top_Pipeline_POOL_CHANNEL_POOL_ROW_POOL_COL1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_full_top_Pipeline_POOL_CHANNEL_POOL_ROW_POOL_COL1}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv2_output float 32 regular {array 1600 { 1 1 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ pool2_output float 32 regular {array 400 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
...
set portList { 
	...
	{ grp_fu_1413_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_1413_p_dout0 sc_in sc_lv 1 signal -1 } 
	...
	{ grp_fu_1417_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_1417_p_dout0 sc_in sc_lv 1 signal -1 } 
	...
	{ grp_fu_1421_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_1421_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1413_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_1413_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_1413_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_1413_p_dout0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1417_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_1417_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_1417_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_1417_p_dout0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1421_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_1421_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_1421_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_1421_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	conv2_output { ap_memory {  { conv2_output_address0 mem_address 1 11 }  { conv2_output_ce0 mem_ce 1 1 }  { conv2_output_q0 mem_dout 0 32 }  { conv2_output_address1 MemPortADDR2 1 11 }  { conv2_output_ce1 MemPortCE2 1 1 }  { conv2_output_q1 MemPortDOUT2 0 32 }  { conv2_output_address2 MemPortADDR2 1 11 }  { conv2_output_ce2 MemPortCE2 1 1 }  { conv2_output_q2 MemPortDOUT2 0 32 }  { conv2_output_address3 MemPortADDR2 1 11 }  { conv2_output_ce3 MemPortCE2 1 1 }  { conv2_output_q3 MemPortDOUT2 0 32 } } }
