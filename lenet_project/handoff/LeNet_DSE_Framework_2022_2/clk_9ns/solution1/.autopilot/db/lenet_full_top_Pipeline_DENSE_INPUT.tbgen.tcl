set moduleName lenet_full_top_Pipeline_DENSE_INPUT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_full_top_Pipeline_DENSE_INPUT}
set C_modelType { void 0 }
set C_modelArgList {
	{ accumulator_5 float 32 regular  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ fc1_output float 32 regular {array 84 { 0 3 } 0 1 }  }
	{ zext_ln139 int 7 regular  }
	{ sext_ln139 int 62 regular  }
	{ conv3_relu float 32 regular {array 120 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accumulator_5", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln139", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln139", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "conv3_relu", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ accumulator_5 sc_in sc_lv 32 signal 0 } 
	...
	{ fc1_output_we0 sc_out sc_logic 1 signal 2 } 
	{ fc1_output_d0 sc_out sc_lv 32 signal 2 } 
	{ zext_ln139 sc_in sc_lv 7 signal 3 } 
	{ sext_ln139 sc_in sc_lv 62 signal 4 } 
	{ conv3_relu_address0 sc_out sc_lv 7 signal 5 } 
	{ conv3_relu_ce0 sc_out sc_logic 1 signal 5 } 
	{ conv3_relu_q0 sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accumulator_5", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "accumulator_5", "role": "default" }} , 
 	...
 	{ "name": "zext_ln139", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln139", "role": "default" }} , 
 	{ "name": "sext_ln139", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln139", "role": "default" }} , 
 	{ "name": "conv3_relu_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "conv3_relu", "role": "address0" }} , 
 	{ "name": "conv3_relu_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv3_relu", "role": "ce0" }} , 
 	{ "name": "conv3_relu_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv3_relu", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "848", "Max" : "848"}
	, {"Name" : "Interval", "Min" : "848", "Max" : "848"}
]}
...
set Spec2ImplPortList { 
	accumulator_5 { ap_none {  { accumulator_5 in_data 0 32 } } }
	...
	fc1_output { ap_memory {  { fc1_output_address0 mem_address 1 7 }  { fc1_output_ce0 mem_ce 1 1 }  { fc1_output_we0 mem_we 1 1 }  { fc1_output_d0 mem_din 1 32 } } }
	zext_ln139 { ap_none {  { zext_ln139 in_data 0 7 } } }
	sext_ln139 { ap_none {  { sext_ln139 in_data 0 62 } } }
	conv3_relu { ap_memory {  { conv3_relu_address0 mem_address 1 7 }  { conv3_relu_ce0 mem_ce 1 1 }  { conv3_relu_q0 mem_dout 0 32 } } }
}
