set moduleName lenet_full_top_Pipeline_OUTPUT_ROW_OUTPUT_COL
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_full_top_Pipeline_OUTPUT_ROW_OUTPUT_COL}
...
set C_modelArgList {
	...
	{ accumulator_2 float 32 regular  }
	{ conv1_output float 32 regular {array 4704 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "accumulator_2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln35 sc_in sc_lv 62 signal 2 } 
	{ empty sc_in sc_lv 9 signal 3 } 
	{ feature_in sc_in sc_lv 64 signal 4 } 
	{ accumulator_2 sc_in sc_lv 32 signal 5 } 
	{ conv1_output_address0 sc_out sc_lv 13 signal 6 } 
	{ conv1_output_ce0 sc_out sc_logic 1 signal 6 } 
	{ conv1_output_we0 sc_out sc_logic 1 signal 6 } 
	{ conv1_output_d0 sc_out sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accumulator_2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "accumulator_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "19765", "Max" : "19765"}
	, {"Name" : "Interval", "Min" : "19765", "Max" : "19765"}
]}
...
set Spec2ImplPortList { 
	...
	accumulator_2 { ap_none {  { accumulator_2 in_data 0 32 } } }
	conv1_output { ap_memory {  { conv1_output_address0 mem_address 1 13 }  { conv1_output_ce0 mem_ce 1 1 }  { conv1_output_we0 mem_we 1 1 }  { conv1_output_d0 mem_din 1 32 } } }
}
