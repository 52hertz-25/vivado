set SynModuleInfo {
  ...
  {SRCNAME lenet_full_top MODELNAME lenet_full_top RTLNAME lenet_full_top IS_TOP 1
    SUBMODULES {
      {MODELNAME fadd_32ns_32ns_32_5_full_dsp_1 RTLNAME lenet_full_top_fadd_32ns_32ns_32_5_full_dsp_1 BINDTYPE op TYPE fadd IMPL fulldsp LATENCY 4 ALLOW_PRAGMA 1}
