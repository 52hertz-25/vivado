# 1 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/variants/mac_unroll_5/lenet_conv.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/variants/mac_unroll_5/lenet_conv.cpp" 2
# 1 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/include\\lenet_conv.h" 1
...
extern "C" __attribute__((sdx_kernel("lenet_full_top", 0))) void lenet_full_top(
    const lenet::data_t feature_in[lenet::INPUT_ELEMS],
    const lenet::weight_t weight[lenet::TOTAL_WEIGHT_ELEMS],
    const lenet::weight_t bias[lenet::TOTAL_BIAS_ELEMS],
    lenet::data_t feature_out[lenet::FC2_OUT_ELEMS]);
# 2 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/variants/mac_unroll_5/lenet_conv.cpp" 2
...
#pragma HLS UNROLL factor=5
 VITIS_LOOP_36_1: for (int index = 0; index < KERNEL_ELEMS; ++index) {
    ...
    OUTPUT_ROW:
        ...
        OUTPUT_COL:
            for (int output_col = 0; output_col < out_w; ++output_col) {
                data_t accumulator = bias[output_channel];
            ...
            INPUT_CHANNEL:
                for (int input_channel = 0; input_channel < IN_C;
                    ...
                    accumulator =
                        mac_5x5(window, &weight[kernel_base], accumulator);
                }
...
extern "C" __attribute__((sdx_kernel("lenet_full_top", 0))) void lenet_full_top(
    ...
    const lenet::weight_t bias[lenet::TOTAL_BIAS_ELEMS],
    lenet::data_t feature_out[lenet::FC2_OUT_ELEMS]) {
#line 11 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/scripts/run_dse.tcl"
#pragma HLSDIRECTIVE TOP name=lenet_full_top
# 269 "D:/lenet_project/handoff/LeNet_DSE_Framework_2022_2/LeNet_DSE_Framework_2022_2/variants/mac_unroll_5/lenet_conv.cpp"
...
#pragma HLS INTERFACE m_axi port=bias offset=slave bundle=gmem2 depth=236
#pragma HLS INTERFACE m_axi port=feature_out offset=slave bundle=gmem3 depth=10
#pragma HLS INTERFACE s_axilite port=feature_in bundle=control
#pragma HLS INTERFACE s_axilite port=weight bundle=control
#pragma HLS INTERFACE s_axilite port=bias bundle=control
#pragma HLS INTERFACE s_axilite port=feature_out bundle=control
