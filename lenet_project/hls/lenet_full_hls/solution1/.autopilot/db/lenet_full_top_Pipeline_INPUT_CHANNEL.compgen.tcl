...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv2_output_address0 { O 11 vector } conv2_output_ce0 { O 1 bit } conv2_output_we0 { O 1 bit } conv2_output_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { pool1_output_address0 { O 11 vector } pool1_output_ce0 { O 1 bit } pool1_output_q0 { I 32 vector } pool1_output_address1 { O 11 vector } pool1_output_ce1 { O 1 bit } pool1_output_q1 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_accumulator_1 \
    op interface \
    ports { accumulator_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln77_1 \
    op interface \
    ports { zext_ln77_1 { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln53_2 \
    op interface \
    ports { zext_ln53_2 { I 4 vector } } \
} "
}
...
set InstName lenet_full_top_flow_control_loop_pipe_sequential_init_U
set CompName lenet_full_top_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix lenet_full_top_ \
}"
} else {
