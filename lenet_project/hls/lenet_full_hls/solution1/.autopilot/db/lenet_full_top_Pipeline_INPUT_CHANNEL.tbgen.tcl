set moduleName lenet_full_top_Pipeline_INPUT_CHANNEL
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_full_top_Pipeline_INPUT_CHANNEL}
set C_modelType { void 0 }
set C_modelArgList {
	{ accumulator_1 float 32 regular  }
	{ gmem1 int 32 regular {axi_master 0}  }
	{ conv2_output float 32 regular {array 1600 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ zext_ln77_1 int 11 regular  }
	{ sext_ln59 int 62 regular  }
	{ zext_ln53_2 int 4 regular  }
	{ zext_ln55 int 4 regular  }
	{ pool1_output float 32 regular {array 1176 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "accumulator_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln77_1", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln59", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln53_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln55", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ accumulator_1 sc_in sc_lv 32 signal 0 } 
	{ conv2_output_address0 sc_out sc_lv 11 signal 2 } 
	{ conv2_output_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv2_output_we0 sc_out sc_logic 1 signal 2 } 
	{ conv2_output_d0 sc_out sc_lv 32 signal 2 } 
	{ zext_ln77_1 sc_in sc_lv 11 signal 3 } 
	{ sext_ln59 sc_in sc_lv 62 signal 4 } 
	{ zext_ln53_2 sc_in sc_lv 4 signal 5 } 
	{ zext_ln55 sc_in sc_lv 4 signal 6 } 
	{ pool1_output_address0 sc_out sc_lv 11 signal 7 } 
	{ pool1_output_ce0 sc_out sc_logic 1 signal 7 } 
	{ pool1_output_q0 sc_in sc_lv 32 signal 7 } 
	{ pool1_output_address1 sc_out sc_lv 11 signal 7 } 
	{ pool1_output_ce1 sc_out sc_logic 1 signal 7 } 
	{ pool1_output_q1 sc_in sc_lv 32 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accumulator_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "accumulator_1", "role": "default" }} , 
 	...
 	{ "name": "zext_ln77_1", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "zext_ln77_1", "role": "default" }} , 
 	{ "name": "sext_ln59", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln59", "role": "default" }} , 
 	{ "name": "zext_ln53_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln53_2", "role": "default" }} , 
 	{ "name": "zext_ln55", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln55", "role": "default" }} , 
 	...
 	{ "name": "pool1_output_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "pool1_output", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	accumulator_1 { ap_none {  { accumulator_1 in_data 0 32 } } }
	...
	conv2_output { ap_memory {  { conv2_output_address0 mem_address 1 11 }  { conv2_output_ce0 mem_ce 1 1 }  { conv2_output_we0 mem_we 1 1 }  { conv2_output_d0 mem_din 1 32 } } }
	zext_ln77_1 { ap_none {  { zext_ln77_1 in_data 0 11 } } }
	sext_ln59 { ap_none {  { sext_ln59 in_data 0 62 } } }
	zext_ln53_2 { ap_none {  { zext_ln53_2 in_data 0 4 } } }
	zext_ln55 { ap_none {  { zext_ln55 in_data 0 4 } } }
	pool1_output { ap_memory {  { pool1_output_address0 mem_address 1 11 }  { pool1_output_ce0 mem_ce 1 1 }  { pool1_output_q0 mem_dout 0 32 }  { pool1_output_address1 MemPortADDR2 1 11 }  { pool1_output_ce1 MemPortCE2 1 1 }  { pool1_output_q1 MemPortDOUT2 0 32 } } }
}
