# Last five arguments are used for compatibility with the Windows launcher.
if {$argc < 5} {
...
set work_dir [file join $root work_level3_pe]
set report_dir [file join $root final_delivery reports level3_pe5]
...
file copy -force $generated_report [file join $report_dir ${top}_pe5_csynth.rpt]
if {[file exists $generated_xml]} {
    file copy -force $generated_xml [file join $report_dir ${top}_pe5_csynth.xml]
}
close_project
puts "LEVEL3_PE5_SYNTH_PASS tag=$tag report=[file join $report_dir ${top}_pe5_csynth.rpt]"
exit 0
