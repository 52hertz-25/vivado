...
HD_PWD='D:/GitHub/vivado/vivado/F_Quantization_W8A8/hls_w8a8/vivado_review/project/LeNet_W8A8_Review.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_system_wrapper.tcl
