...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 73 \
    name local_weight_V_3 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename local_weight_V_3 \
    op interface \
    ports { local_weight_V_3_address0 { O 7 vector } local_weight_V_3_ce0 { O 1 bit } local_weight_V_3_we0 { O 1 bit } local_weight_V_3_d0 { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_weight_V_3'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 74 \
    name local_weight_V_2 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename local_weight_V_2 \
    op interface \
    ports { local_weight_V_2_address0 { O 7 vector } local_weight_V_2_ce0 { O 1 bit } local_weight_V_2_we0 { O 1 bit } local_weight_V_2_d0 { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_weight_V_2'"
}
}
