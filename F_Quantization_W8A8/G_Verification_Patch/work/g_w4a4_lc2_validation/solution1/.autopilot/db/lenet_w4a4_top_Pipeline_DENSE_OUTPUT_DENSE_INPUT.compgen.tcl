...
set id 110
set name lenet_w4a4_top_mac_muladd_3ns_4s_14s_14_4_1
...
set ce_signed 0
set out_width 14
set arg_lists {i0 {3 0 +} i1 {4 1 +} m {7 1 +} i2 {14 1 +} p {14 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename conv3_relu_V \
    op interface \
    ports { conv3_relu_V_address0 { O 7 vector } conv3_relu_V_ce0 { O 1 bit } conv3_relu_V_q0 { I 3 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv3_relu_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fc1_acc_V \
    op interface \
    ports { fc1_acc_V_address0 { O 7 vector } fc1_acc_V_ce0 { O 1 bit } fc1_acc_V_we0 { O 1 bit } fc1_acc_V_d0 { O 14 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'fc1_acc_V'"
}
}
