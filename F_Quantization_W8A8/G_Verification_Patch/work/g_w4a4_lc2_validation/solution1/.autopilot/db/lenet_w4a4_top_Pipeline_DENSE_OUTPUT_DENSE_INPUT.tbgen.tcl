set moduleName lenet_w4a4_top_Pipeline_DENSE_OUTPUT_DENSE_INPUT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_w4a4_top_Pipeline_DENSE_OUTPUT_DENSE_INPUT}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 0}  }
	{ weight int 64 regular  }
	{ conv3_relu_V int 3 regular {array 120 { 1 3 } 1 1 }  }
	{ fc1_acc_V int 14 regular {array 84 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "conv3_relu_V", "interface" : "memory", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "fc1_acc_V", "interface" : "memory", "bitwidth" : 14, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ conv3_relu_V_address0 sc_out sc_lv 7 signal 2 } 
	{ conv3_relu_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv3_relu_V_q0 sc_in sc_lv 3 signal 2 } 
	{ fc1_acc_V_address0 sc_out sc_lv 7 signal 3 } 
	{ fc1_acc_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ fc1_acc_V_we0 sc_out sc_logic 1 signal 3 } 
	{ fc1_acc_V_d0 sc_out sc_lv 14 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv3_relu_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "conv3_relu_V", "role": "q0" }} , 
 	{ "name": "fc1_acc_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "fc1_acc_V", "role": "address0" }} , 
 	{ "name": "fc1_acc_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fc1_acc_V", "role": "ce0" }} , 
 	{ "name": "fc1_acc_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fc1_acc_V", "role": "we0" }} , 
 	{ "name": "fc1_acc_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "fc1_acc_V", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "lenet_w4a4_top_Pipeline_DENSE_OUTPUT_DENSE_INPUT",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "10095", "EstimateLatencyMax" : "10095",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "conv3_relu_V", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "fc1_acc_V", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_3ns_4s_14s_14_4_1_U110", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	lenet_w4a4_top_Pipeline_DENSE_OUTPUT_DENSE_INPUT {
		gmem1 {Type I LastRead 10 FirstWrite -1}
		weight {Type I LastRead 0 FirstWrite -1}
		conv3_relu_V {Type I LastRead 10 FirstWrite -1}
		fc1_acc_V {Type O LastRead -1 FirstWrite 14}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10095", "Max" : "10095"}
	, {"Name" : "Interval", "Min" : "10095", "Max" : "10095"}
]}
...
set Spec2ImplPortList { 
	...
	conv3_relu_V { ap_memory {  { conv3_relu_V_address0 mem_address 1 7 }  { conv3_relu_V_ce0 mem_ce 1 1 }  { conv3_relu_V_q0 in_data 0 3 } } }
	fc1_acc_V { ap_memory {  { fc1_acc_V_address0 mem_address 1 7 }  { fc1_acc_V_ce0 mem_ce 1 1 }  { fc1_acc_V_we0 mem_we 1 1 }  { fc1_acc_V_d0 mem_din 1 14 } } }
}
