set moduleName lenet_w4a4_top_Pipeline_WRITE_LOGITS
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_w4a4_top_Pipeline_WRITE_LOGITS}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 32 regular {axi_master 1}  }
	{ sext_ln563 int 62 regular  }
	{ fc2_quant_V int 4 regular {array 10 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "logits","offset": { "type": "dynamic","port_name": "logits","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln563", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "fc2_quant_V", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln563 sc_in sc_lv 62 signal 1 } 
	{ fc2_quant_V_address0 sc_out sc_lv 4 signal 2 } 
	{ fc2_quant_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ fc2_quant_V_q0 sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln563", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln563", "role": "default" }} , 
 	...
 	{ "name": "fc2_quant_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "fc2_quant_V", "role": "q0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "lenet_w4a4_top_Pipeline_WRITE_LOGITS",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "sext_ln563", "Type" : "None", "Direction" : "I"},
			{"Name" : "fc2_quant_V", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "WRITE_LOGITS", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter2", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	lenet_w4a4_top_Pipeline_WRITE_LOGITS {
		gmem2 {Type O LastRead -1 FirstWrite 2}
		sext_ln563 {Type I LastRead 0 FirstWrite -1}
		fc2_quant_V {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	sext_ln563 { ap_none {  { sext_ln563 in_data 0 62 } } }
	fc2_quant_V { ap_memory {  { fc2_quant_V_address0 mem_address 1 4 }  { fc2_quant_V_ce0 mem_ce 1 1 }  { fc2_quant_V_q0 mem_dout 0 4 } } }
}
