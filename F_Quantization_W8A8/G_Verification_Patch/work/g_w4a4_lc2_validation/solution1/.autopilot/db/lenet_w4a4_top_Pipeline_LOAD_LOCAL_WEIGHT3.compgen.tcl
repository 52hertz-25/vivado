...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 96 \
    name local_weight_V_1 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename local_weight_V_1 \
    op interface \
    ports { local_weight_V_1_address0 { O 8 vector } local_weight_V_1_ce0 { O 1 bit } local_weight_V_1_we0 { O 1 bit } local_weight_V_1_d0 { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_weight_V_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename local_weight_V \
    op interface \
    ports { local_weight_V_address0 { O 8 vector } local_weight_V_ce0 { O 1 bit } local_weight_V_we0 { O 1 bit } local_weight_V_d0 { O 4 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_weight_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_phi_mul389 \
    op interface \
    ports { phi_mul389 { I 16 vector } } \
} "
}
