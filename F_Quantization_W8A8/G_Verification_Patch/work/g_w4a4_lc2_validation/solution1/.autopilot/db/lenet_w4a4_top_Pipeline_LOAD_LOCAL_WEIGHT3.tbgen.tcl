set moduleName lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 0}  }
	{ local_weight_V_1 int 4 regular {array 200 { 0 3 } 0 1 }  }
	{ local_weight_V int 4 regular {array 200 { 0 3 } 0 1 }  }
	{ phi_mul389 int 16 regular  }
	{ weight int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "local_weight_V_1", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_weight_V", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "phi_mul389", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ local_weight_V_1_we0 sc_out sc_logic 1 signal 1 } 
	{ local_weight_V_1_d0 sc_out sc_lv 4 signal 1 } 
	{ local_weight_V_address0 sc_out sc_lv 8 signal 2 } 
	{ local_weight_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_weight_V_we0 sc_out sc_logic 1 signal 2 } 
	{ local_weight_V_d0 sc_out sc_lv 4 signal 2 } 
	{ phi_mul389 sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_weight_V_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V_1", "role": "we0" }} , 
 	{ "name": "local_weight_V_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V_1", "role": "d0" }} , 
 	...
 	{ "name": "local_weight_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V", "role": "we0" }} , 
 	{ "name": "local_weight_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V", "role": "d0" }} , 
 	{ "name": "phi_mul389", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "phi_mul389", "role": "default" }} , 
 	{ "name": "weight", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "weight", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT3",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "local_weight_V_1", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "local_weight_V", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "phi_mul389", "Type" : "None", "Direction" : "I"},
			{"Name" : "weight", "Type" : "None", "Direction" : "I"}],
		"Loop" : [
			{"Name" : "LOAD_LOCAL_WEIGHT", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter9", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter9", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT3 {
		gmem1 {Type I LastRead 8 FirstWrite -1}
		local_weight_V_1 {Type O LastRead -1 FirstWrite 9}
		local_weight_V {Type O LastRead -1 FirstWrite 9}
		phi_mul389 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	local_weight_V_1 { ap_memory {  { local_weight_V_1_address0 mem_address 1 8 }  { local_weight_V_1_ce0 mem_ce 1 1 }  { local_weight_V_1_we0 mem_we 1 1 }  { local_weight_V_1_d0 mem_din 1 4 } } }
	local_weight_V { ap_memory {  { local_weight_V_address0 mem_address 1 8 }  { local_weight_V_ce0 mem_ce 1 1 }  { local_weight_V_we0 mem_we 1 1 }  { local_weight_V_d0 mem_din 1 4 } } }
	phi_mul389 { ap_none {  { phi_mul389 in_data 0 16 } } }
