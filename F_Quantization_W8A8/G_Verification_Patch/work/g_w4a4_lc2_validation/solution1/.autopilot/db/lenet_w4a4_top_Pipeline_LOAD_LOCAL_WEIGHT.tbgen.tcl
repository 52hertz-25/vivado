set moduleName lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 0}  }
	{ local_weight_V_5 int 4 regular {array 13 { 0 3 } 0 1 }  }
	{ local_weight_V_4 int 4 regular {array 13 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "weight","offset": { "type": "dynamic","port_name": "weight","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "local_weight_V_5", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_weight_V_4", "interface" : "memory", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ local_weight_V_5_address0 sc_out sc_lv 4 signal 1 } 
	{ local_weight_V_5_ce0 sc_out sc_logic 1 signal 1 } 
	{ local_weight_V_5_we0 sc_out sc_logic 1 signal 1 } 
	{ local_weight_V_5_d0 sc_out sc_lv 4 signal 1 } 
	{ local_weight_V_4_address0 sc_out sc_lv 4 signal 2 } 
	{ local_weight_V_4_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_weight_V_4_we0 sc_out sc_logic 1 signal 2 } 
	{ local_weight_V_4_d0 sc_out sc_lv 4 signal 2 } 
	{ phi_mul sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_weight_V_5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V_5", "role": "address0" }} , 
 	{ "name": "local_weight_V_5_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V_5", "role": "ce0" }} , 
 	{ "name": "local_weight_V_5_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V_5", "role": "we0" }} , 
 	{ "name": "local_weight_V_5_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V_5", "role": "d0" }} , 
 	{ "name": "local_weight_V_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V_4", "role": "address0" }} , 
 	{ "name": "local_weight_V_4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V_4", "role": "ce0" }} , 
 	{ "name": "local_weight_V_4_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_weight_V_4", "role": "we0" }} , 
 	{ "name": "local_weight_V_4_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "local_weight_V_4", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "local_weight_V_5", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "local_weight_V_4", "Type" : "Memory", "Direction" : "O"},
...
set ArgLastReadFirstWriteLatency {
	lenet_w4a4_top_Pipeline_LOAD_LOCAL_WEIGHT {
		gmem1 {Type I LastRead 8 FirstWrite -1}
		local_weight_V_5 {Type O LastRead -1 FirstWrite 9}
		local_weight_V_4 {Type O LastRead -1 FirstWrite 9}
...
set Spec2ImplPortList { 
	...
	local_weight_V_5 { ap_memory {  { local_weight_V_5_address0 mem_address 1 4 }  { local_weight_V_5_ce0 mem_ce 1 1 }  { local_weight_V_5_we0 mem_we 1 1 }  { local_weight_V_5_d0 mem_din 1 4 } } }
	local_weight_V_4 { ap_memory {  { local_weight_V_4_address0 mem_address 1 4 }  { local_weight_V_4_ce0 mem_ce 1 1 }  { local_weight_V_4_we0 mem_we 1 1 }  { local_weight_V_4_d0 mem_din 1 4 } } }
