...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lenet_w4a4_top.autotvin_gmem0.dat"
         "c.lenet_w4a4_top.autotvin_gmem1.dat"
         "c.lenet_w4a4_top.autotvin_feature_in.dat"
         "c.lenet_w4a4_top.autotvin_weight.dat"
         "c.lenet_w4a4_top.autotvin_logits.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lenet_w4a4_top.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
