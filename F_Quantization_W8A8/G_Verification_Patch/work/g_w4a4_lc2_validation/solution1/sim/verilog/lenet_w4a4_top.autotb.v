...
`define AUTOTB_DUT      lenet_w4a4_top
`define AUTOTB_DUT_INST AESL_inst_lenet_w4a4_top
`define AUTOTB_TOP      apatb_lenet_w4a4_top_top
`define AUTOTB_LAT_RESULT_FILE "lenet_w4a4_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "lenet_w4a4_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_lenet_w4a4_top_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvin_gmem1.dat"
`define AUTOTB_TVIN_feature_in_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvin_feature_in.dat"
`define AUTOTB_TVIN_weight_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvin_weight.dat"
`define AUTOTB_TVIN_logits_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvin_logits.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.lenet_w4a4_top.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.lenet_w4a4_top.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 20;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 380843;
parameter LENGTH_feature_in = 1;
parameter LENGTH_gmem0 = 512;
parameter LENGTH_gmem1 = 30735;
parameter LENGTH_gmem2 = 10;
parameter LENGTH_logits = 1;
...
reg end_logits;
reg [31:0] size_logits;
reg [31:0] size_logits_backup;
reg end_gmem2;
reg [31:0] size_gmem2;
