...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe D:/GitHub/vivado/vivado/F_Quantization_W8A8/hls_w8a8/data/mnist_w8a8 D:/GitHub/vivado/vivado/F_Quantization_W8A8/hls_w4a4/model/int4_weights D:/GitHub/vivado/vivado/F_Quantization_W8A8/G_Verification_Patch/results/g_balanced20_cosim.csv | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lenet_w4a4_top.autotvin.dat"
	set constFileTvOut       "lenet_w4a4_top.autotvout.dat"
	set constFileHdlTvIn     "lenet_w4a4_top.autohdltvin.dat"
	set constFileHdlTvOut    "lenet_w4a4_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
