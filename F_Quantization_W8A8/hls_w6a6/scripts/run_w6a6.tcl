...
#   export  : C synthesis + export IP catalog
#   all     : C simulation + synthesis + RTL co-simulation + export
# ============================================================
...
if {$mode ne "csim" &&
    ...
    puts "Valid modes: csim, csynth, cosim, export, all"
    exit 2
}
...
set tb_file     [file join $root tb tb_lenet_w6a6.cpp]
...
# Verify the five W6A6 weight files.
set required_weights [list \
    "conv1.weight.int6.txt" \
    "conv2.weight.int6.txt" \
    "conv3.weight.int6.txt" \
    "fc1.weight.int6.txt" \
    "fc2.weight.int6.txt" \
]
...
if {$mode eq "csim" || $mode eq "all"} {
    puts "============================================================"
    puts "Starting W6A6 C simulation"
    ...
    puts "============================================================"
    puts "W6A6 C simulation completed"
    puts "============================================================"
}
...
if {$mode eq "csynth" ||
    ...
    puts "============================================================"
    puts "Starting W6A6 C synthesis"
    puts "============================================================"

    csynth_design

    puts "============================================================"
    puts "W6A6 C synthesis completed"
    puts "============================================================"
}
...
if {$mode eq "cosim" || $mode eq "all"} {
    puts "============================================================"
    puts "Starting W6A6 RTL co-simulation"
    ...
    puts "============================================================"
    puts "W6A6 RTL co-simulation completed"
    puts "============================================================"
}

# ------------------------------------------------------------
# 11. Export IP catalog
# ------------------------------------------------------------
...
if {$mode eq "export" || $mode eq "all"} {
    ...
    export_design \
        -format ip_catalog \
        -rtl verilog \
        -output [file join $export_dir lenet_w6a6_top_ip.zip]
}
...
puts "============================================================"
puts "W6A6 HLS operation completed successfully"
puts "Mode: $mode"
puts "============================================================"
